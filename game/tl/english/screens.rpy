...
translate english strings:
    ...
    new "Skip dialogue without making choices"
    ...
    new "Skip dialogue while holding"
    ...
    new "Toggle {a=https://www.renpy.org/l/voicing}text-to-speech{/a}"
